...
You can ONLY read the files specified in your prompt (chapter file + graph file). You cannot search for or read any other files. Update the graph and save it.
